  ...
  return (
    <aside className="w-full max-w-[280px] flex flex-col gap-6">
      <div className="flex items-center gap-3">
        <div className="w-[54px] h-[54px] rounded-full bg-[#ffe5d4] text-[#8b0000] flex items-center justify-center font-semibold text-[18px] overflow-hidden">
          {avatarUrl ? (
            <img
              src={avatarUrl}
              alt=""
          ...
          <button
            ...
            className={`text-left px-3 py-2 rounded-[10px] text-[14px] transition ${
              activeSection === section.id
                ? "bg-[#fff4e6] text-[#8b0000] font-semibold"
                : "text-[#2b2730] hover:bg-[#fff4e6]"
            }`}
          >
            {section.label}
          </button>
